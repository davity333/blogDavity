          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-400 text-sm font-mono rounded transition-colors"
              >
